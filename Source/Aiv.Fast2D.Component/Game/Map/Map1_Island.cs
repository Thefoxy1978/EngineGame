using OpenTK;
using System;
using Aiv.Fast2D.Component.AI;
using Aiv.Fast2D.Component.UI;

namespace Aiv.Fast2D.Component
{
    public class Map1_Island : Scene
    {
        ...
        public override void InitializeScene()
        {
            ...
            var map1 = new Tiled.Map("Assets/Level/1.tmx");
        ...
        private void ChangeScene(EventArgs eventArgs)
        {
            ...
            switch(SUA.Teleport_ID)
            {
                case 1:
                    if (PickKey.AssKey)
                    {
                        Game.TriggerChangeScene(new Map3_ShyminerOpen());
                    }
                    else
                    {
                        Game.TriggerChangeScene(new Map3_Shyminer());
                    }
                    break;
                case 2:
                    Game.TriggerChangeScene(new Map2_Cass());
                    break;
